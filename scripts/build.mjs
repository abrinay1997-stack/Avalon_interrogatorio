...
${body}
<footer class="site-footer">Nada de esto consta en acta.</footer>
...
function coverHTML() {
  return `<section class="cover">
    ...
    <nav class="cover-nav">
      ...
      <a href="#nota-historica">Nota del autor</a>
    </nav>
  </section>`;
}
...
function colophonHTML() {
  return `<section class="matter colophon">
    ...
    <p class="colophon-note">Cualquier parecido entre estas voces y una voz viva —o entre esta confesión y la verdad— queda a cuenta del lector.</p>
  </section>`;
}
